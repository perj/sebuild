...
func internalToolsGobuildSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "internal/tools/gobuild.sh", size: 4863, mode: os.FileMode(493), modTime: time.Unix(1561717583, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func rulesRulesNinja() (*asset, error) {
	...
	info := bindataFileInfo{name: "rules/rules.ninja", size: 7644, mode: os.FileMode(420), modTime: time.Unix(1561717583, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
